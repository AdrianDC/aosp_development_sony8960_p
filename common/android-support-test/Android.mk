...
LOCAL_SRC_FILES := rules/rules-0.6-beta-1-release.jar
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := rules/rules-0.6-beta-1-release-no-dep.jar
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := $(COMMON_JAVA_PACKAGE_SUFFIX)
LOCAL_SDK_VERSION := 8
# Uninstallable static Java libraries.
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := runner/runner-0.6-beta-1-release-no-dep.jar
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := $(COMMON_JAVA_PACKAGE_SUFFIX)
LOCAL_SDK_VERSION := 8
# Uninstallable static Java libraries.
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := espresso/espresso-core-2.3-beta-1-release.jar
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := $(COMMON_JAVA_PACKAGE_SUFFIX)
# Uninstallable static Java libraries.
LOCAL_UNINSTALLABLE_MODULE := true
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := espresso/espresso-core-2.3-beta-1-release-no-dep.jar
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := $(COMMON_JAVA_PACKAGE_SUFFIX)
# Uninstallable static Java libraries.
LOCAL_UNINSTALLABLE_MODULE := true
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := espresso/espresso-contrib-2.3-beta-1-release.jar
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := $(COMMON_JAVA_PACKAGE_SUFFIX)
# Uninstallable static Java libraries.
LOCAL_UNINSTALLABLE_MODULE := true
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := espresso/espresso-contrib-2.3-beta-1-release-no-dep.jar
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := $(COMMON_JAVA_PACKAGE_SUFFIX)
# Uninstallable static Java libraries.
LOCAL_UNINSTALLABLE_MODULE := true
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := espresso/espresso-idling-resource-2.3-beta-1-release-no-dep.jar
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := $(COMMON_JAVA_PACKAGE_SUFFIX)
# Uninstallable static Java libraries.
LOCAL_UNINSTALLABLE_MODULE := true
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := espresso/espresso-intents-2.3-beta-1-release.jar
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := $(COMMON_JAVA_PACKAGE_SUFFIX)
# Uninstallable static Java libraries.
LOCAL_UNINSTALLABLE_MODULE := true
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := espresso/espresso-intents-2.3-beta-1-release-no-dep.jar
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := $(COMMON_JAVA_PACKAGE_SUFFIX)
# Uninstallable static Java libraries.
LOCAL_UNINSTALLABLE_MODULE := true
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := espresso/espresso-web-2.3-beta-1-release.jar
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := $(COMMON_JAVA_PACKAGE_SUFFIX)
# Uninstallable static Java libraries.
LOCAL_UNINSTALLABLE_MODULE := true
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := espresso/espresso-web-2.3-beta-1-release-no-dep.jar
LOCAL_MODULE_CLASS := JAVA_LIBRARIES
LOCAL_MODULE_SUFFIX := $(COMMON_JAVA_PACKAGE_SUFFIX)
# Uninstallable static Java libraries.
LOCAL_UNINSTALLABLE_MODULE := true
