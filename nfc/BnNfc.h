...
#ifndef HIDL_GENERATED_ANDROID_HARDWARE_TESTS_BN_Nfc_H_
#define HIDL_GENERATED_ANDROID_HARDWARE_TESTS_BN_Nfc_H_
...
#endif  // HIDL_GENERATED_ANDROID_HARDWARE_TESTS_BN_Nfc_H_
